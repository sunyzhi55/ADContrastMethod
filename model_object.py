...
models = {
    ...
    'MultimodalADNet': {
        ...
        'Loss': CrossEntropyLoss,
        'Scheduler': get_scheduler,
        'Run': run_main_for_multimodalADNet,
    },
    'IMF': {
    ...
    'VAPL': {
        # 32 * 42 * 32, 16 * 21 * 16, 8 * 10 * 8, 4 * 5 * 4 =》 (batch, 1, 96, 128, 96)
        # 37 * 45 * 37, 18 * 22 * 18, 9 * 11 * 9, 4 * 5 * 4 =》 (batch, 1, 113, 137, 113)
        'Name': 'VAPL',
        'Model': thenet,
        'dataset': MriCliDataset,
        # 'shape': (96, 128, 96),
