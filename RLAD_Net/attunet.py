...
from RLAD_Net.Other_method.utils import UnetConv3, UnetUp3, UnetGridGatingSignal3
import torch.nn.functional as F
# from RLAD_Net.layers.grid_attention_layer import GridAttentionBlock3D
from RLAD_Net.networks_other import init_weights
from RLAD_Net.layers.grid_attention_layer import GridAttentionBlock3D
...
if __name__ == "__main__":
    ...
    model = unet_grid_attention_3D(n_classes=1).to(device)
