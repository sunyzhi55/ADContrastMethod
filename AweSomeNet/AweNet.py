...
class CrossModalCBAM(nn.Module):
    ...
    def forward(self, img_feat, table_feat):
        ...
        channel_attn_map = self.sigmoid(table_channel_attn + max_out + avg_out)  # [B, C, 1, 1, 1]
        channel_attn_map = channel_attn_map.view(B, C, 1, 1, 1)
