...
from MDL_Net.Disease_incuded_ROI import Disease_Guide_ROI
from MDL_Net.Latent_Space_aware_Learning import FactorizedBilinearPooling
from MDL_Net.Local_aware_Learning import LocalAwareLearning
from MDL_Net.Self_adaptive_Transformer import SelfAdaptiveTransformer
...
def generate_model(model_depth, in_planes, num_classes, **kwargs):
    ...
    if model_depth == 10:
        ...
        model = MDL_Net(Bottleneck, [3, 24, 36, 3], get_inplanes(), n_input_channels=in_planes,
                        n_classes=num_classes, **kwargs)
...
if __name__ == '__main__':
    ...
    参数量 2869143
    flops: 28059.67 M, params: 2.83 M
    time:1.3936049938201904s
    """
